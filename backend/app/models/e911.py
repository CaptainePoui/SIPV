...
class E911Address(Base):
    ...
    # ERPCRM est maitre pour les succursales (company_sites) -- ce record est une
    # copie synchronisee, retrouvee/mise a jour par cet id (voir sync.py /site).
    erpcrm_site_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), unique=True)
