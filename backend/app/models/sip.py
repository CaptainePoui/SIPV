...
class SIPExtension(Base):
    ...
    forward_immediate_destination_type: Mapped[str] = mapped_column(String(20), default="extension", server_default="extension")
    ...
    forward_busy_destination_type: Mapped[str] = mapped_column(String(20), default="extension", server_default="extension")
    ...
    forward_no_answer_destination_type: Mapped[str] = mapped_column(String(20), default="voicemail", server_default="voicemail")
    ...
    forward_offline_destination_type: Mapped[str] = mapped_column(String(20), default="voicemail", server_default="voicemail")
